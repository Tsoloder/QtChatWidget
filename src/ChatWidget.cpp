...
void ChatWidget::applyStyleSheet(const Theme &t)
{
    ...
    QString qss = QStringLiteral(
        ...
        "QPushButton#optionBtn_default { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.18), stop:0.5 ${optionBtnBg}, stop:1 rgba(0,0,0,0.10));"
        "  color: ${optionBtnText}; border: 1px solid ${optionBtnBorder}; border-left: 3px solid ${optionBtnAccent};"
        "  border-radius: 8px; padding: 8px 12px; text-align: left; font-size: 13px; }"
        "QPushButton#optionBtn_default:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.28), stop:0.5 ${optionBtnHoverBg}, stop:1 rgba(0,0,0,0.06)); border-left: 3px solid ${optionBtnHoverAccent}; color: ${optionBtnHoverText}; }"
        ...
        "QPushButton#optionBtn_primary { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.35), stop:0.5 ${approveBtnBg}, stop:1 rgba(0,0,0,0.20));"
        "  color: ${approveBtnText}; border: 1px solid ${approveBtnBorder}; border-left: 3px solid ${approveBtnBorder};"
        "  border-radius: 8px; padding: 8px 12px; text-align: left; font-size: 13px; font-weight: bold; }"
        "QPushButton#optionBtn_primary:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.42), stop:0.5 ${approveBtnHoverBg}, stop:1 rgba(0,0,0,0.16)); border-color: ${approveBtnHoverBorder}; }"
        // danger：危险操作（如"取消"）
        "QPushButton#optionBtn_danger { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.22), stop:0.5 ${rejectBtnBg}, stop:1 rgba(0,0,0,0.14));"
        "  color: ${rejectBtnText}; border: 1px solid ${rejectBtnBorder}; border-left: 3px solid ${rejectBtnBorder};"
        "  border-radius: 8px; padding: 8px 12px; text-align: left; font-size: 13px; }"
        "QPushButton#optionBtn_danger:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.30), stop:0.5 ${rejectBtnHoverBg}, stop:1 rgba(0,0,0,0.10)); border-color: ${rejectBtnHoverBorder}; }"
        // success：成功确认类
        "QPushButton#optionBtn_success { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.30), stop:0.5 ${confirmBtnBg}, stop:1 rgba(0,0,0,0.18));"
        "  color: ${confirmBtnText}; border: 1px solid ${confirmBtnBorder}; border-left: 3px solid ${confirmBtnBorder};"
        "  border-radius: 8px; padding: 8px 12px; text-align: left; font-size: 13px; }"
        "QPushButton#optionBtn_success:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.38), stop:0.5 ${confirmBtnHoverBg}, stop:1 rgba(0,0,0,0.14)); border-color: ${confirmBtnHoverBorder}; color: ${confirmBtnHoverText}; }"
        // 兼容旧的 #optionBtn（无 style 后缀）
        "QPushButton#optionBtn { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.18), stop:0.5 ${optionBtnBg}, stop:1 rgba(0,0,0,0.10));"
        "  color: ${optionBtnText}; border: 1px solid ${optionBtnBorder}; border-left: 3px solid ${optionBtnAccent};"
        "  border-radius: 8px; padding: 8px 12px; text-align: left; font-size: 13px; }"
        "QPushButton#optionBtn:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(255,255,255,0.28), stop:0.5 ${optionBtnHoverBg}, stop:1 rgba(0,0,0,0.06)); border-left: 3px solid ${optionBtnHoverAccent}; color: ${optionBtnHoverText}; }"
